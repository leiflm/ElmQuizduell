...
int QD_CON_USERS_CURRENT_USER_GAMES = 0;
int QD_CON_USERS_FIND_USER = 0;
int QD_CON_USERS_ADD_FRIEND = 0;
...
static void _init_events(void)
{
    #define EV_INIT(e) e = ecore_event_type_new()
        ...
        EV_INIT(QD_CON_USERS_CURRENT_USER_GAMES);
        EV_INIT(QD_CON_USERS_FIND_USER);
        EV_INIT(QD_CON_USERS_ADD_FRIEND);
